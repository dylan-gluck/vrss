...
describe('Service Health Checks', () => {
  it('should have PostgreSQL database running and healthy', async () => {
    ...
    try {
      const healthCheck = execSync(
        'docker-compose exec -T db pg_isready -U vrss_user -d vrss',
        { timeout: 10000 }
      ).toString();
  ...
  it('should have backend API running and healthy', async () => {
  ...
  it('should have frontend running and reachable', async () => {
  ...
  it('should have all services up according to docker-compose ps', () => {
  ...
  it('should respond to health check via Makefile command', () => {
    try {
...
describe('Service Connectivity', () => {
  it('should allow backend to connect to database', async () => {
    ...
    try {
      const output = execSync(
        'docker-compose exec -T backend sh -c "nc -zv db 5432"',
        { timeout: 10000 }
      ).toString();
  ...
  it('should have services on correct ports', () => {
