...
describe("Volume Persistence", () => {
  ...
  it(
    "should persist database data across container restarts",
    async () => {
  ...
  it(
    "should have persistent volume mounted",
    () => {
  ...
  it(
    "should have media storage volume mounted",
    () => {
      const volumeOutput = execSync("docker volume ls").toString();
  ...
  it(
    "should have backend logs volume mounted",
    () => {
      const volumeOutput = execSync("docker volume ls").toString();
  ...
  it(
    "should have frontend node_modules volume mounted",
    () => {
      const volumeOutput = execSync("docker volume ls").toString();
